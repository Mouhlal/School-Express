...
<head>
  ...
  <title> Modifier Profile : {{$profile->name}}</title>
...
<body class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover" style="background-image:url('https://source.unsplash.com/1L71sPT5XKc');">
  ...
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<form action="" method="POST">
                ...
                <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                    ...
                    <a class="link" href="#"><svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Unsplash</title><path d="M7.5 6.75V0h9v6.75h-9zm9 3.75H24V24H0V10.5h7.5v6.75h9V10.5z"/></svg></a>
	...
	<div class="w-full lg:w-2/5">
		...
		<img src="{{asset('storage/'.$profile->image)}}" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
