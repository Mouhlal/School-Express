        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          ...
          <p class="leading-normal text-2xl mb-8">
            Chez SchoolGear Express, notre objectif est de rendre l'éducation accessible
             et passionnante en offrant des fournitures scolaires de la meilleure qualité
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                Programmes de Fourniture Scolaire
            </h3>
            <p class="text-gray-600 mb-8">
                Nous travaillons avec des écoles et des institutions éducatives pour créer des programmes
                de fourniture scolaire personnalisés, adaptés à leurs besoins spécifiques.              <br />
              <br />
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
                Service Client Personnalisé               </h3>
              <p class="text-gray-600 mb-8">
                Notre équipe de service client est disponible pour vous aider à choisir les produits qui répondent le mieux à
                 vos besoins et pour résoudre toute question ou problème que vous pourriez rencontrer.                <br />
                <br />
          ...
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                Nous suivons les dernières tendances et innovations dans le domaine de
                l'éducation pour offrir des produits à la pointe de la technologie.              </p>
            </a>
          </div>
            ...
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                La satisfaction de nos clients est notre priorité.
                 Nous offrons un service client exceptionnel pour répondre à tous vos besoins.              </p>
            </a>
          </div>
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                Nous soutenons des initiatives éducatives et des programmes scolaires pour enrichir la communauté.              </p>
            </a>
          </div>
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
      ...
      <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
        ...
        <div class="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
          <div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
            <div class="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
              <div class="p-8 text-3xl font-bold text-center border-b-4">
                Articles d'Art et de Création
              </div>
              <ul class="w-full text-center text-sm">
                <li class="border-b py-4">Peintures</li>
                <li class="border-b py-4">pinceaux</li>
                <li class="border-b py-4">papiers de dessin</li>
              </ul>
            </div>
            <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
              <div class="flex items-center justify-center">
          ...
          <div class="flex flex-col w-5/6 lg:w-1/3 mx-auto lg:mx-0 rounded-lg bg-white mt-4 sm:-mt-6 shadow-lg z-10">
            <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <div class="w-full p-8 text-3xl font-bold text-center">Fournitures de Bureau</div>
              <div class="h-1 w-full gradient my-0 py-0 rounded-t"></div>
              <ul class="w-full text-center text-base font-bold">
                <li class="border-b py-4">Stylos</li>
                <li class="border-b py-4">crayons</li>
                <li class="border-b py-4">Cahiers</li>
                <li class="border-b py-4">Agenda</li>
                <li class="border-b py-4">classeurs</li>
              </ul>
            </div>
            <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
              <div class="flex items-center justify-center">
          ...
          <div class="flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4">
            <div class="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
              ...
              <ul class="w-full text-center text-sm">
                <li class="border-b py-4">Calculatrices scientifiques </li>
                <li class="border-b py-4">microscopes</li>
                <li class="border-b py-4">télescopes</li>
              </ul>
            </div>
            <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
              <div class="flex items-center justify-center">
